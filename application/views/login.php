        ...
        <div class="col-md-offset-3 col-md-6">
            <form class="form-horizontal" action="login/check" method="post">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="inputEmail3" name="u_name" placeholder="用户名">
                    <i class="fa fa-user"></i>
                </div>
                <div class="form-group help">
                    <input type="password" class="form-control" id="inputPassword3" name="u_pw" placeholder="密　码">
